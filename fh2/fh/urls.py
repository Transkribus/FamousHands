...
urlpatterns = [
    ...
    url(r'^timeline_k$', views.timeline_k, name='timeline_k'),
    url(r'^timeline_cent$', views.timeline_cent, name='timeline_cent'),
    url(r'^timeline_dec$', views.timeline_dec, name='timeline_dec'),
